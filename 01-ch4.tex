...
\begin{itemize}
    \item \verb|type CKKSKeyChain struct|：CKKS 方案所使用的密钥链结构体，包含了公私钥对象的指针\verb|CKKSPrivateKey *rlwe.SecretKey| \verb|CKKSPublicKey  *rlwe.PublicKey|，以及一个唯一标识符 \verb|Identifier uuid.UUID|
