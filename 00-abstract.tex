...
\end{abstract}
\keywords{移动支付, 同态加密, 隐私保护, CKKS方案, Lattigo, ECDSA 数字签名}
...
\end{enabstract}
\enkeywords{Mobile Payment, Homomorphic Encryption, Privacy Preservation, CKKS(Cheon-Kim-Kim-Song) Scheme, Lattigo, ECDSA}
